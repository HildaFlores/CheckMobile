...
public class GreenAdapterServicio extends RecyclerView.Adapter<GreenAdapterServicio.NumberViewHolder> {


    private static final String TAG = GreenAdapterServicio.class.getSimpleName();
    private ArrayList<ProductoServicio> servicios = new ArrayList<>();
     ...
     */
    public GreenAdapterServicio(int numberOfItems, ArrayList<ProductoServicio> service) {
    ...
    public NumberViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        int layoutIdForListItem = R.layout.row_producto_servicio;
    ...
    class NumberViewHolder extends RecyclerView.ViewHolder {
         ...
         *                 {@link GreenAdapterServicio#onCreateViewHolder(ViewGroup, int)}
         */
